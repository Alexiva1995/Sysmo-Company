...
Route::group(['prefix' => 'admin'], function () {
  ...
  // });
    ...
    Route::prefix('store')->group(function(){
      ...
      Route::get('showOrder/{id}', [ProductWarehouseController::class,'showOrder'])->name('show-orders');
      Route::post('editOrder/', [ProductWarehouseController::class,'editOrder'])->name('edit-order');
