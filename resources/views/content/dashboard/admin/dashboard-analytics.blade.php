        ...
        <div class="card-body text-center">
          ...
          <div class="text-center">
            ...
            <p class="card-text m-auto w-75">
              <button class="btn btn-danger" data-link="{{Request::url()}}/register?referred_id={{Auth::user()->id}}" id="referrals_link" onclick="copyReferralsLink();">Copiar link de referido <i class="far fa-copy"></i></button>
            </p>
          </div>
        </div>
      </div>
