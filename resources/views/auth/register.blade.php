                ...
                <div class="card-body">
                    ...
                    <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="register-password-confirm" class="form-label">Confirmar Pass</label>
                    ...
                    <p class="text-center mt-2">
                        <span class="creaunacuenta">¿Ya tienes una cuenta?</span>
                        @if (Route::has('login'))
                        <a href="{{ route('login') }}">
                            <span class="text-primary creaunacuenta2">Inicia sesión</span>
                        </a>
                        @endif
                    </p>
